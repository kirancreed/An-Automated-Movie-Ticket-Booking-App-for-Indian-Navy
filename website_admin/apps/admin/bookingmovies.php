...
<!-- SHOW_TIME  RATING  DESCRIPTION -->
            ...
            if (!empty($movies)) {
                foreach ($movies as $movie) {
                    ...
                    ?>
        <a href="viewbooking.php?data=<?php echo urlencode($mid); ?>" class="button-link view-bookings-button">View bookings</a>
        <a href="reservationchart.php?data=<?php echo urlencode($mid); ?>" class="button-link view-reservation-chart-button">Reservation chart</a>
        <a href="stopBooking.php?data=<?php echo urlencode($mid); ?>" class="button-link stop-booking-button">Stop booking</a>
